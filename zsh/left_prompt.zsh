...
DECO_L_COLOR='%{[38;5;015m%}'    # last color
COMMAND_COLOR='%{[38;5;255m%}' # command color
local hist='015' # 238
# HISTORY_COLOR='%{[38;5;054m%}' # command color  # 111, 105, 040, 106, 190, 201, 177, 184, 003
HISTORY_COLOR='%{[01;38;5;093m%}' # command color  # 111, 105, 040, 106, 190, 201, 177, 184, 003
